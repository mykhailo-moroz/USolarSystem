...
using SolarSystem.Modules.GamePlay.Scripts.PathCreator.Editor.Helper;
using SolarSystem.Modules.GamePlay.Scripts.PathCreator.Runtime.Objects;
using SolarSystem.Modules.GamePlay.Scripts.PathCreator.Runtime.Utility;
using UnityEditor;
using UnityEditor.IMGUI.Controls;
using UnityEngine;

namespace SolarSystem.Modules.GamePlay.Scripts.PathCreator.Editor {
